...
Ti.include('../../ui/common/settingsInclude.js');
...
function settingsWindow() {
	...
	addPreference({
		...
		table: tableView,
		title: 'Logout',
		description: user.objectForKey("username"),
		button: 'Logout',
	...
	onclick: function() {
			var opts = {'tfLabel':'Change your Name here.','tfValue':'userName','updateID':'a2','winTitle':'Update Name'};
